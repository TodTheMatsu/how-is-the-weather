...
function Today({ weatherData, getWeatherCondition }) {
  ...
  return (
    <motion.div className="h-[400px] w-[1200px]  backdrop-blur-3xl bg-opacity-35 bg-white shadow-xl rounded-3xl flex flex-col items-center justify-center relative space-y-4" initial={{scale: 0, y:200, opacity: 0}} whileInView={{scale: 1, opacity: 1, y:0, transition: { duration: 1}}}>
